...
import 'package:flutter_carrot_market/app.dart';
import 'package:flutter_carrot_market/common/dart/extension/context_extension.dart';
...
extension ColorExtension on Color {
  ...
  Color swatchShade(int swatchValue) =>
      HSLColor.fromColor(
        this,
      ).withLightness(1 - ((math.min(swatchValue, 1000)) / 1000)).toColor();
}
